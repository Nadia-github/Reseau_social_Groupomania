      ...
      <v-container fluid>
        ...
        >
          <div class="presentation">
            <img
              class="img-id"
              v-if="post.user.sexe == 'H'"
              src="/homme.png"
              alt="homme"
            />
            <img
              class="img-id"
              v-if="post.user.sexe == 'F'"
              src="/femme.png"
              alt="femme"
            />
          ...
          <div id="titre_disposition" style="text-align: center">
            {{ post.titre }}
          </div>
          ...
          <v-card-text
            style="text-align: justify; display: flex; flex-direction: column"
          >
            <div>{{ post.contenu }}</div>
            <br />
            <br />
            <div id="dateCreation">
              Commentaire créé le : {{ dateTime(post.createdAt) }}
            </div>
          </v-card-text>

          <template v-slot:actions>
            <v-btn
              v-if="post.userId == userId || isAdmin"
